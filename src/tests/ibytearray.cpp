...
void IByteArrayTest::relational_data()
{
    ...
    QTest::newRow("bergamota and furrovine")
        << QByteArray("bergamota") << QByteArray("furrovine");
    QTest::newRow("Bergamota and furrovine")
        << QByteArray("Bergamota") << QByteArray("furrovine");
    QTest::newRow("bergamota and Furrovine")
        << QByteArray("bergamota") << QByteArray("Furrovine");
...
void IByteArrayTest::caseInsensitivity_data()
{
    ...
    QTest::newRow("Bergamota and beRgaMotA")
        << QByteArray("Bergamota") << QByteArray("beRgaMotA");
    QTest::newRow("fURroVinE and FurrOvIne")
        << QByteArray("fURroVinE") << QByteArray("FurrOvIne");
}
